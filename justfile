...
restart:
    Get-Process -Name uvicorn -ErrorAction SilentlyContinue | Stop-Process -Force; $env:OLLAMA_LLM_MODEL="qwen2:7b"; $env:OLLAMA_EMBED_MODEL="nomic-embed-text"; uv run uvicorn main:app --host 127.0.0.1 --port 8000
